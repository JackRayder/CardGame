...
namespace Arkham 
{
    public class Card : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        ...
        public void OnBeginDrag(PointerEventData eventData)
        {
            ...
            isDraggable = DefaultParent.GetComponent<DropPlace>().Type == FieldType.HAND;
        ...
        public void OnDrag(PointerEventData eventData)
        {
            ...
            if (TempCardGO.transform.parent != DefaultTempCardParent) TempCardGO.transform.SetParent(DefaultTempCardParent);

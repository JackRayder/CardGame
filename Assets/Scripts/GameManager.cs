...
namespace Arkham
{
    public class Game
    {
        ...
        List<Cards> GiveDeckCard()
        {
            ...
            list.Add(CardRenderer.AllCards[27]);
            list.Add(CardRenderer.AllCards[27]);
            list.Add(CardRenderer.AllCards[28]);
            list.Add(CardRenderer.AllCards[28]);
            list.Add(CardRenderer.AllCards[26]);
            list.Add(CardRenderer.AllCards[26]);
            list.Add(CardRenderer.AllCards[25]);
            list.Add(CardRenderer.AllCards[25]);
            list.Add(CardRenderer.AllCards[24]);
            list.Add(CardRenderer.AllCards[24]);
            list.Add(CardRenderer.AllCards[4]);
            list.Add(CardRenderer.AllCards[3]);
            list.Add(CardRenderer.AllCards[6]);
            list.Add(CardRenderer.AllCards[7]);
            list.Add(CardRenderer.AllCards[8]);
            list.Add(CardRenderer.AllCards[9]);
            list.Add(CardRenderer.AllCards[10]);
            list.Add(CardRenderer.AllCards[11]);
            list.Add(CardRenderer.AllCards[12]);
            list.Add(CardRenderer.AllCards[13]);
            list.Add(CardRenderer.AllCards[14]);
            list.Add(CardRenderer.AllCards[15]);
            ...
            list.Add(CardRenderer.AllCards[0]);
            list.Add(CardRenderer.AllCards[0]);
            return list;
        }
